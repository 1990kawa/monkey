...
import (
	...
	"github.com/1990kawa/monkey/ast"
...
// 		t.Fatalf("program.Statements does not coutain 3 statements. got=%d", len(program.Statements))
// 	}
//
...
func TestFunctionPawrameterParsing(t *testing.T) {
	tests := []struct {
		input          string
